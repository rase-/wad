...
<html>
    ...
    <body>
        ...
        <c:forEach var="course" items="${courses}">
            ${course.name}, attending: ${course.attending}, lectured by: ${course.lecturer} <sec:authorize access="hasRole('student')"><a href="student/course/${course.id}">Sign up</a></sec:authorize> <br />
        </c:forEach>
    </body>
</html>
