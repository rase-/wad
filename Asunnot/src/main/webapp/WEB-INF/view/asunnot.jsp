...
<html>
    ...
    <body>
        ...
        <c:forEach var="asunto" items="${asunnot}">
            ${asunto.henkilo.nimi}, ${asunto.henkilo.sahkopostiosoite}, ${asunto.henkilo.puhelinnumero}: ${asunto.osoite}, ${asunto.postinumero} ${asunto.kaupunki}, rakennettu ${asunto.vuosi}, ${asunto.koko} neliötä, kunto ${asunto.kunto} <br />
        </c:forEach>
        <h2>Lisää asunto</h2>
